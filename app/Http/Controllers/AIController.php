...
class AIController extends Controller
{
    ...
    public function imageOutput($param, $post, $user): JsonResponse
    {
        ...
        $engineCheck = match ($param['image_generator']) {
            'flux-pro', 'flux-2-flex', 'flux-2-flex/edit', 'ideogram', 'ideogram-v2', 'flux-pro-kontext', 'flux-pro/kontext/text-to-image', 'nano-banana', 'nano-banana-pro', 'seedream/v4/text-to-image', 'flux/schnell', 'flux-pro/v1.1', 'flux-realism', 'imagen4', 'fal-ai', 'xai/grok-imagine-image', 'xai/grok-imagine-image/edit' => EngineEnum::FAL_AI->value,
